...
- `demo2d <../example/demo2d/>`__: ``Graphics2D`` の機能一式 (背景パターン、多角形の星、α と加算合成のスプライト、
  GRAY1 アイコン、RGB444 オフスクリーンの転送、図形、クリップ、4 種のフォント)。``shapoco::gfx2d`` だけを使います。
...
どちらも 480x320 の RGB565BE バッファに描画し、``docs/example/viewer.js`` が RGB565BE をキャンバスに展開しています。
